...
const SkillComponents = ({ skills }: { skills: any }) => {
            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <p className="max-w-2xl mx-auto text-gray-400 mt-6">
                        I&lsquo;ve developed expertise in various technologies through hands-on experience and continuous learning
                    </p>
                </motion.div>
                ...
                <div className="mb-20 overflow-x-hidden">
                    ...
                    >
                        {skills?.skills?.map((skill: { image: string; skill: string }, index: number) => (
                            <motion.div
                                key={index}
